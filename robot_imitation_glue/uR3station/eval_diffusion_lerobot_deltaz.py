...
from robot_imitation_glue.eval_agent_delta_z import eval
...
if __name__ == "__main__":
    checkpoint_path = "/home/rtalwar/robot-imitation-glue/outputs/train/2025-11-27/21-01-05_deltaz_dynamic_rgb_instrumentation_short_action_pred_100k/checkpoints/last/pretrained_model"
    train_dataset_path = (
        "/home/rtalwar/robot-imitation-glue/datasets/delta_z_dynamic_rgb_instumentation"
    )
    eval_scenarios_dataset_path = train_dataset_path

    eval_dataset_name = "eval_delta_z_button"
    ...
    env = UR3eStation(with_instrumentation=True,with_spectogram_model=True)
    env.reset()
